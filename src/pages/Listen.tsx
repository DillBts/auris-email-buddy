        ...
        >
          ...
          <div className="glass-surface rounded-2xl p-8 text-center">
            <div className="w-20 h-20 rounded-2xl gradient-primary flex items-center justify-center mx-auto mb-6 shadow-soft">
              <span className="text-2xl font-bold text-primary-foreground">{current.from[0]}</span>
            </div>

            <PriorityBadge priority={current.priority} />
            <h2 className="text-lg font-bold text-foreground mt-3 mb-1">{current.subject}</h2>
            <p className="text-sm text-muted-foreground mb-2">From {current.from}</p>
            ...
            {/* Preview text */}
            <div className="bg-muted/50 rounded-xl p-4 mb-6 text-left max-h-40 overflow-y-auto">
